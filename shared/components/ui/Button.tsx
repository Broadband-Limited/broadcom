...
const Button: React.FC<ButtonProps> = ({
  ...
  // Define base styles
  const baseStyles =
    'flex items-center justify-center font-medium rounded-none transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 cursor-pointer';
