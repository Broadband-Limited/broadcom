...
export default function Hero() {
  return (
    <section className="!p-0 bg-background aspect-square md:aspect-[3/1] grid grid-cols-1 grid-rows-1">
      ...
      <div className="w-full h-full md:w-2/3 col-start-1 row-start-1 z-[5] flex flex-col justify-end gap-6 mt-auto px-4 md:px-32 py-2 md:py-4">
        <h2 className="!text-background">
          Get in Touch with Us – We’re Here to Help!
        </h2>

        <p className="!text-background !text-sm opacity-60 md:w-2/3">
