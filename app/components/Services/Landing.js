  ...
  return (
    <section className="flex flex-col items-center gap-8 md:px-64 mb-16">
      <div className="w-full">
        <h2 className="text-4xl font-bold appear">Leading the Future of Network <br className='hidden md:block' />& Infrastructure Solutions</h2>

        <p className='text-gray-600 mt-8 appear'>Broadband Communication Networks Limited is a leading African telecommunications provider specializing in network solutions for various sectors. We offer comprehensive services from network installations to managed solutions and cater to end-to-end telecommunications needs.</p>
      </div>

      <div className="flex-shrink-0 w-screen h-auto md:aspect-[21/5] overflow-hidden relative appear">
