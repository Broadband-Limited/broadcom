  ...
  return (
    <section className="!p-0 bg-background aspect-square md:aspect-[4/3] lg:aspect-[3/1] grid grid-cols-1 grid-rows-1">
      <Image
        ...
        width={1000}
        height={1000}
        className="w-full aspect-square md:aspect-[4/3] lg:aspect-[3/1] col-start-1 row-start-1 z-[2]"
      />

      <div className="w-full h-full col-start-1 row-start-1 z-[3] bg-gradient-to-t from-[#000000ce] via-[#00000094] to-[#00000000]"></div>

      <div className="w-full h-full col-start-1 row-start-1 z-[5] flex flex-col justify-end gap-6  !text-background mt-auto px-4 md:px-16 lg:px-32 py-2 lg:py-4">
